...
export function WhatsappFab() {
  ...
  return (
    ...
    >
      {/*
        El glifo oficial de WhatsApp, de una sola pieza y en un solo color.
        El que había antes lo dibujé yo a mano y se rellenaba mal: el hueco
        del globo se cerraba y salía un disco blanco con un teléfono dentro,
        que no es la marca de nadie. Este es el trazado canónico —el mismo de
        Simple Icons, dominio público— y se reconoce a 30 px, que es lo único
        que se le pide a un botón flotante.

        Va como trazado y no como imagen: una petición menos para un control
        que tiene que estar desde el primer cuadro.
      */}
